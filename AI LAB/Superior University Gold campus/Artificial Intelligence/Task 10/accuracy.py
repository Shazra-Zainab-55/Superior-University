...
df = pd.read_csv("AI LAB\Superior University Gold campus\Artificial Intelligence\Task 10\Dataset.csv")
...
test_x.head(2)
test_y.head(2)
model_svc = SVC(C=1, gamma='scale', kernel='rbf', random_state=0)  # Modified parameters
